...
const types = [
    {
        ...
        dotColor: "bg-[#1e3a8a]",
        desc: "Menganalisis data historis untuk memprediksi probabilitas. Digunakan untuk personalisasi jalur pembelajaran, analisis risiko, dan optimasi stok di retail.",
    },
    {
        id: "gen",
