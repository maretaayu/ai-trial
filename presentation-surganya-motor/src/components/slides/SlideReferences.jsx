...
const SlideReferences = () => {
    const references = [
        {
            title: "Ruangguru: AI for L&D",
            desc: "Laporan Riset Implementasi Kecerdasan Artifisial dalam Pengembangan SDM & Pelatihan Korporasi.",
            link: "https://enterprise.ruangguru.com/ai-report-2025",
            icon: ShieldCheck
        },
        {
