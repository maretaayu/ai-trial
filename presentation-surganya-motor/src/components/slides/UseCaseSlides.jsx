...
import {
    ...
    Database, Search, Layout, BarChart3, Quote, Target, FileText, BookOpen
} from 'lucide-react';
...
// ══════════════════════════════════════════════════════════════════════════════
export const SlideUseCaseLD = () => (
    <DeptSlide
        icon={BookOpen}
        iconBg="bg-orange-100 text-orange-600"
        dept="Learning & Development"
        deptColor="bg-orange-100 text-orange-700"
        title="Scaling Expertise. Personalized Learning."
        subtitle="L&D teams manage training for large workforces at scale. AI turns static manuals into interactive mentors."
        accentBorder="bg-orange-50 border-orange-200 text-orange-800"
        cases={[
            {
                before: "Drafting a new 10-module training curriculum takes 2 weeks of manual research and slide design.",
                after: "AI Agent digests technical docs & drafting a 10-module curriculum + quizzes in 30 minutes. Team focused on strategy.",
                color: "bg-orange-50 border-orange-200 text-orange-800"
            },
            {
                before: "Staff manually search through technical manuals for specific SOPs, creating downtime.",
                after: "SOP-Bot (powered by NotebookLM) provides instant, verified answers and citations from the manuals in seconds.",
                color: "bg-orange-50 border-orange-200 text-orange-800"
            },
            {
                before: "Training evaluation lacks insights into performance gaps across multiple branches.",
                after: "Analytics Agent automatically identifies specific regions and topics needing retraining based on performance data.",
                color: "bg-orange-50 border-orange-200 text-orange-800"
            },
        ]}
        tools={[
            ...
            { name: "Synthesia", logo: "https://www.synthesia.io/favicon.ico" },
            { name: "ChatGPT 4o", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/ChatGPT_logo.svg/240px-ChatGPT_logo.svg.png" },
            { name: "Gemini Enterprise", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Google_Gemini_logo.svg/320px-Google_Gemini_logo.svg.png" },
            { name: "Quizgecko", logo: "https://quizgecko.com/favicon.ico" },
        ]}
    />
);
